    ...
    try {
            ...
            await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: 'MRDIEHARD-MD MD',
                        serverMessageId: -1
                    }
                }
            });
        ...
        await sock.sendMessage(chatId, {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: 'https://whatsapp.com/channel/0029Vb785Ak4CrfmYSGIvY1b',
                    newsletterName: 'MRDIEHARD-MD MD',
                    serverMessageId: -1
                }
            }
...
function isBotMentionedInMessage(message, botNumber) {
    ...
    if (textContent) {
        ...
        const botNames = [global.botname?.toLowerCase(), 'bot', 'mrdiehard', 'mrdiehard bot'];
...
module.exports = {
    ...
    execute: async (sock, remoteJid, message, args) => {
        return autoreadCommand(sock, remoteJid, message);
    },
    autoreadCommand,
    isAutoreadEnabled,
